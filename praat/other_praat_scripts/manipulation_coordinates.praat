...
# corrected for reference values: 03-12-2018
#
...
d$ = "/Users//Stimuli_Exp8_selection/annotated/"

# directory for saving the manipulated files
dir$ = "/Users//Manipulation/pause3bra_3/"
...
## Calculate new values ##
	...
	if condition$ == "bra"
		...
		# final lengthening to min, pause duration to max (maxP)
		p3newMaxP = (maxpauseBra/ruttMaxBra) * ruttMin
		facp3newMaxP = p3newMaxP/p3
...
#########################################################################
## Pause3 Max, Length and f0-Range Min ##
	select Manipulation 'name$'
	Edit
	editor Manipulation 'name$'
...
## duration of pause ##
	...
	Select: 'innerstartp3', 'innerendp3'
	Remove duration point(s)
	Add duration point at: 'innerstartp3', 'facp3newMaxP'
	Add duration point at: 'innerendp3', 'facp3newMaxP'

pause now in Pause Max
...
#########################################################################
## Length s8 and f0-Range Max, Pause Min ##
	select Manipulation 'name$'
	Edit
	editor Manipulation 'name$'
