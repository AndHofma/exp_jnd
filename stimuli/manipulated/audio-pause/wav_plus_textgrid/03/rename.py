...
path = "/Users/Andrea Hofmann/OneDrive/PhD/phd_perception_production_link/dissertation/procedure_all/exp_jnd/stimuli_manipulated/audio-pause/wav_plus_textgrid/03"
os.chdir(path)
